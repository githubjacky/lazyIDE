...
return {
    ...
    -- fuzzy finder
    {
        ...
        keys = {
            ...
            -- { "<leader>tR", Util.telescope("oldfiles", { cwd = vim.loop.cwd() }), desc = "Recent (cwd)" },
            -- git
            ...
            -- { "<leader>ltd", "<cmd>Telescope diagnostics bufnr=0<cr>", desc = "Document diagnostics" },
            -- { "<leader>ltD", "<cmd>Telescope diagnostics<cr>", desc = "Workspace diagnostics" },
